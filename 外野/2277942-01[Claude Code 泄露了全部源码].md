...
####  chronicle  
##### 65#       发表于 2026-4-1 01:28

<blockquote>redbuck 发表于 2026-4-1 00:56
其实我是有点奇怪这次为啥搞这么轰动

claude 本来就是 npm 分发，是直接 js 装到客户环境的，虽然混淆了， ...</blockquote>
就是这个道理，但凡国产这几个agent抄下，也不会这么难用。现在喂到嘴边了，你总不能不动了。


*****

####  PurplePeppers  
##### 66#       发表于 2026-4-1 01:40

这下真感谢A圣开源了<img src="https://static.stage1st.com/image/smiley/face2017/049.png" referrerpolicy="no-referrer">
...
####  Awanano  
##### 68#       发表于 2026-4-1 03:58

国内配套agent一直做的烂是很奇怪，不会是想学donothing&amp;win那一套吧<img src="https://static.stage1st.com/image/smiley/face2017/067.png" referrerpolicy="no-referrer">
我现在有用的朋友自研的agent，嫌弃cc某些地方不好用自己烧token出的一个工具。所以大厂没理由搓不好的
...
####  土星魔豆  
##### 69#       发表于 2026-4-1 07:36

<blockquote><a href="httphttps://stage1st.com/2b/forum.php?mod=redirect&amp;goto=findpost&amp;pid=69422012&amp;ptid=2277942" target="_blank">redbuck 发表于 2026-4-1 00:45</a>
没那么玄乎，应该就是草台了</blockquote>
你说的这种有可能，但是草台的也可能是 ai
正常情况下，开发 测试 生产，使用不同的编译参数，开发的人没动机去改这个参数，他看到的总是能 debug 源码的环境

ai 只看到了构建的配置文件，但是因为某次不稳定，没注意到这个文件是生产用的，看到隔壁的文件都是打开的（而且可能多个配置文件都是打开的，开发 测试 准生产），顺手模仿一下，就给开了
...
强就强在它那个框架，基模水平未必比国内开源强多少 ...</blockquote>
试试opencode，可以很方便的切各种模型，你就能体会到模型的重要性


*****

####  7uly  
##### 71#       发表于 2026-4-1 08:04

<blockquote><a href="httphttps://stage1st.com/2b/forum.php?mod=redirect&amp;goto=findpost&amp;pid=69422040&amp;ptid=2277942" target="_blank">redbuck 发表于 2026-4-1 00:56</a>
其实我是有点奇怪这次为啥搞这么轰动

claude 本来就是 npm 分发，是直接 js 装到客户环境的，虽然混淆了， ...</blockquote>
只是圈外的狂欢而已，cc的源码其实去年就泄露过一次；并且最核心的prompt，其实可以通过反向代理来得到，专门做这个的人其实早把这些核心研究完了。opencode之类的其实就是这么做出来的。


*****

####  harry3  
##### 72#       发表于 2026-4-1 09:52
...
####  小野賢章  
##### 73#       发表于 2026-4-1 09:52

<blockquote><a href="httphttps://stage1st.com/2b/forum.php?mod=redirect&amp;goto=findpost&amp;pid=69421173&amp;ptid=2277942" target="_blank">hugosol 发表于 2026-3-31 20:31</a>

估计就是程序员自己用ai写的配置没仔细review就发布出去了+1

话说这种泄漏出来的代码直接山寨来用不会有法 ...</blockquote>
个人、小厂随便用，大厂用clean room就可以，就是一个人看，看完之后给另一个人描述，另一个人复刻。现在有 AI 了，让 Claude Code 自己复刻一个。


*****

####  兰开夏  
##### 74#       发表于 2026-4-1 11:17

泄露+媒体传播也有意义的，领导看完觉得那么强你们开发的垃圾怎么xxx都没有，功能搬运优先级就从p2变成p1甚至p0了。
